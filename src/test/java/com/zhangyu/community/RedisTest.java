...
public class RedisTest {
    ...
    public void testHashes() {
        ...
        redisTemplate.opsForHash().put(redisKey, "password", "1234567");
    ...
    public void testBoundOperations() {
        ...
        BoundZSetOperations boundZSetOperations = redisTemplate.boundZSetOps("test:students");
        ...
        System.out.println(boundZSetOperations.zCard());
    }
